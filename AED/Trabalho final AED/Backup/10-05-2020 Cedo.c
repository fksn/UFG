...
void BuscaProduto(PRODUTO * ITEM, int NUM_PROD)
{
    ...
    while (op == 1)
    {
        ...
        if (num == 1)
        {
            ...
            printf("Cod: %.2lf ", ITEM[mid].P_COMPRA);
            printf("Cod: %.2lf ", ITEM[mid].P_VENDA);
            printf("Cod: %d\n\n", ITEM[mid].QUANT);
        ...
        else
        {
            ...
            for (i = 0; i < NUM_PROD-1; i++)
            {
                if (strcmp(ITEM[i].NOME, N) == 0) 
                {
                    ...
                    printf("Cod: %.2lf ", ITEM[i].P_COMPRA);
                    printf("Cod: %.2lf ", ITEM[i].P_VENDA);
                    printf("Cod: %d\n", ITEM[i].QUANT);
                    aux = 1;
                }
            }
...
//             while(i >= 0) 
//             {
//                 if (strcmp(N, ITEM[j].NOME) < 0)
//                 {
//                     printf("entrou 1\n\n\n");
//                     strcpy(ITEM[j+1].NOME, ITEM[j].NOME);
//                     ITEM[j+1].COD = ITEM[j].COD;
//                     ITEM[j+1].P_COMPRA = ITEM[j].P_COMPRA;
//                     ITEM[j+1].P_VENDA = ITEM[j].P_VENDA;
//                     ITEM[j+1].QUANT = ITEM[j].QUANT;
//                 }
//                 else
//                 {
//                     printf("entrou 2\n\n\n");
//                     if (j = NUM_PROD - 2)
//                     {
//                         strcpy(ITEM[j+1].NOME, N);
//                         printf("Digite o código do produto: ");
//                         scanf("%d", &(ITEM[j+1].COD));

//                         printf("Digite o preço de compra do produto: ");
//                         scanf("%lf", &(ITEM[j+1].P_COMPRA));

//                         printf("Digite o preço de venda do produto: ");
//                         scanf("%lf", &(ITEM[j+1].P_VENDA));
                        
//                         printf("Digite a quantidade: ");
//                         scanf("%d", &(ITEM[j+1].QUANT));
//                     }
//                     else
//                     {
//                         printf("entrou 3\n\n\n");
